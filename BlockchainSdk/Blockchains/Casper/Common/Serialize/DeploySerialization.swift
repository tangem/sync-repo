...
enum DeploySerialization {
    ...
    static func serialize(fromDeploy: Deploy) -> String {
        var retStr = ""
    ...
    static func getBodyHash(fromDeploy: Deploy) -> String {
    ...
    static func getHeaderHash(fromDeployHeader: DeployHeader) -> String {
...
enum DeployHeaderSerialization {
    ...
    static func serialize(from: DeployHeader) -> String {
...
enum DeployApprovalSerialization {
    ...
    static func serialize(from: [DeployApprovalItem]) -> String {
