...
class TokenListViewModel: ObservableObject {
    ...
    func saveChanges() {
        ...
        DispatchQueue.global().async {
            self.update(tokenListMaintainer: tokenListMaintainer, entries: &alreadySaved)
            self.updateStorage(tokenListMaintainer: tokenListMaintainer, entries: alreadySaved)
        }
    }

    func updateStorage(tokenListMaintainer: TokenListMaintainer, entries: [StorageEntry]) {
...
private extension TokenListViewModel {
    ...
    func update(tokenListMaintainer: TokenListMaintainer, entries: inout [StorageEntry]) {
