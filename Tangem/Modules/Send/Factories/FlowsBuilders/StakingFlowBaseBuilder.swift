...
<<<<<<< HEAD:Tangem/Modules/Send/SendFactories/StepBuilders/Flows/StakingFlowBaseBuilder.swift
    func makeSendViewModel(manager: some StakingManager, router: SendRoutable) -> SendViewModel {
=======
    func makeSendViewModel(manager: any StakingManager, router: SendRoutable) -> SendBaseViewModel {
>>>>>>> 38eeb8483 (IOS-7634 Folders):Tangem/Modules/Send/Factories/FlowsBuilders/StakingFlowBaseBuilder.swift
